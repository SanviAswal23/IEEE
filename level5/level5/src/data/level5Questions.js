const questions = [
    ...
    {
      q: "Fill in the blank in the Python recursion logic: def factorial(n): if n == 0 or n == 1: return 1 return n * factorial(____)",
      a: "n - 1",
      type: "Coding"
    },
    {
    ...
    {
      q: "HTML – Script Alert: Fill in the alert message. alert(\"____\");",
      a: "Hello World",
      type: "Coding"
    }
  ];
